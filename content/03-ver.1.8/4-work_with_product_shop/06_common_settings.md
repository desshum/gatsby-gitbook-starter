...
- найти ссылку на документацию для разработчика с описанием создания задачи для сервиса kloud.one.shop и обработчика статуса заказа (API сервис для подтверждения заказова в интернет-магазине).