---
slug: "/post115"
title: "Модальное окно Настройки ППС в Личном кабинете"
sort: "08"
---

### Модальное окно Настройки ППС 

### Поле Интеграция с 1С: ЖКХ
...
3.  Вводе лицевого счета, которого нет в базе данных платформы Kloud.One.  
4.  Вводе лицевого счета, по которому нет приборов учета в базе данных платформы Kloud.One.
...
![Картинка](./images/settings_apps_enter_data_picker_dtmf.png "Выбрали DTMF")
...
![Картинка](./images/settings_apps_enter_data_picker_voice+dtmf.png "Выбрали голосом+DTMF")
...
![Картинка](./images/settings_apps_voice.png "Выпадающий список Голос автоответчика")
...
Этот флажок отвечает за привязку лицевого счета к номеру телефона. После первого приема показаний, при включенном флажке, номер телефона сохраняется в базе данных с привязкой лицевого счета.

![Картинка](./images/settings_apps_checkbox_chain_number.png "Флажок Включить привязку лицевых счетов к номеру телефона")
...
![Картинка](./images/settings_apps_timetable_table.png "Дополнительные поля при выборе По расписанию")

### Включить запись

При включении флажка автоответчик будет записывать разговор с момента поднятия трубки абонента и до сброса трубки роботом/абонентом. Также можно прослушать записи звонка в **Журнале звонков**.  
🛈 При включенном флажке будет произнесена фраза: "Внимание, для улучшения работы сервиса разговор может быть записан".  

![Картинка](./images/settings_apps_checkbox_record.png "Поле Включить запись")

### Закрыть

При нажатии на кнопку **Закрыть** модальное окно **Настройки приема показаний** закрывается.

![Картинка](./images/settings_apps_butt_close.png "Кнопка Закрыть")
...
![Картинка](./images/settings_apps_reset_settings.png "Кнопка Сбросить настройки")
